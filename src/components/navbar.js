...
function Navbar() {
    ...
    <div className="container my-2">
      ...
      <button href="" className="btn btn-outline-info">Contact Me</button>
      </Link> 
      <button
      ...
      <div className="collapse navbar-collapse flex-grow-0" id="collapseNav">
        ...
        <Link to="/all-projects" className="nav-item nav-link text-dark h6 mx-1 my-auto">
            Projects
          </Link>
          <Link to="/all-blogs" className="nav-item nav-link text-dark h6 mx-1 my-auto">
            Blogs
          </Link>
        </div>
      </div>
