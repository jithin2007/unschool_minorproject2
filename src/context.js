    ...
    recommendations: [
      {
        ...
        company: "Mr Beast",
        designation: "Owner",
        message: "There were lots of smiles and personal relationships that we’ll all take forward in supporting what we do—creating original content for our subscribers",
      },
      {
        id: 2,
        name: "Harry Potter",
        company: "Hogwarts",
        designation: "Heir",
        message: "He ain't a very good developer",
      },
      {
        id: 3,
        name: "The Professor",
        company: "NRB Of Spain",
        designation: "Mastermind",
        message: "In this world, everything is governed by balance. There’s what you stand to gain and what you stand to lose. And when you think you’ve got nothing to lose, you become overconfident.",
      },
      {
        id: 4,
        name: "PewDiePie",
